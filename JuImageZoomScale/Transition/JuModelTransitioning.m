...
@implementation JuModelTransitioning

+(JuModelTransitioning *)juTransitionType:(BOOL)present{
    JuModelTransitioning *trans=[[JuModelTransitioning alloc]init];
    trans.presented=present;
    return trans;
}
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    if (self.isPresented) {
        [self juPresentAnimation:transitionContext];
    }else{
        [self juDismissAnimation:transitionContext];
    }
}
//实现present动画逻辑代码
- (void)juPresentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
...
//实现dismiss动画逻辑代码
- (void)juDismissAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
